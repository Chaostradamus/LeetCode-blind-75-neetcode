...
# double binary search
    # first we find midpoint in rows then compare target to first element in row and then last element in row to move pointers
    # once we find correct row we do binary search on that row with l and r pointers
    # cutting that row in half by doing l + r //2 = mid until target is found else return false
